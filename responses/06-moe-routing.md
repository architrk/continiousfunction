Here’s a self‑contained client component for Next.js that visualizes MoE routing with GSAP animations and the UX you described:
...
You can drop this into components/MoERoutingDemo.tsx in your Next.js app (remember to npm install gsap) and place <MoERoutingDemo /> inside any page. It follows the same “interactive card” vibe as your other explorable components. 

...
This should drop straight into your Next.js app as components/LossLandscape3D.tsx and fits the styling conventions of your other interactive cards (sliders, captions, etc.). It uses @react-three/fiber + @react-three/drei for the 3D scene and integrates cleanly with your shared math/color utilities. 

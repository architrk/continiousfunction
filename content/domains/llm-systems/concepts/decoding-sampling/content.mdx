...
Then you sample from the truncated distribution:
...
Use the demo to see how temperature/top-p reshape the distribution step by step, and how small changes can flip a model from diverse to repetitive.

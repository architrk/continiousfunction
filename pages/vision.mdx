...
<nav className="breadcrumb" style={{ fontSize: '0.85rem', marginBottom: '1.5rem', color: '#7a7468' }}>
  <Link href="/" style={{ color: 'var(--converge-teal)', textDecoration: 'none' }}>Home</Link>
  <span style={{ margin: '0 0.5rem', color: '#5a5448' }}>/</span>
  <span style={{ color: '#b8b0a0' }}>Vision</span>
</nav>
